...
ttt <- ttheme_default(core=list(fg_params=list(hjust=0, x=.01, cex = .9)),
...
bottom <- (plot_spacer() | t1 | plot_spacer() | t2) + plot_layout(widths = c(.01, .4, .2, .4))
