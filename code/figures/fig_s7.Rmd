...
bottom <- (pc | pd) + plot_layout(widths = c(.75, .25))
...
```{r}
ggsave(ff, filename = "../../figures/fig_s7.png", width = 11, height = 8.5)

ggsave(ff, filename = "../../figures/fig_s7.pdf", device = cairo_pdf, width = 11, height = 8.5)

write_rds(ff, "../../figures/fig_s7.rds")
```
